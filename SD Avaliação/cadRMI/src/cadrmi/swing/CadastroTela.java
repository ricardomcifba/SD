...
public class CadastroTela extends javax.swing.JFrame {
     ...
     */
    protected CadastroTela() {
        initComponents();
    }
    
    public static CadastroTela getInstance(){
        if(instance == null)
            instance = new CadastroTela();
        return instance;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        Procurar.getInstance().setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.dispose();
        Apagar.getInstance().setVisible(true);
    ...
    private static CadastroTela instance;
